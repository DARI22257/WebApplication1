...
public partial class _1135ChubrikContext : DbContext
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Credential>(entity =>
        {
            ...
            entity.HasIndex(e => e.Employeeid, "Credential_Shift_FK");
            ...
            entity.HasOne(d => d.EmployeeNavigation).WithMany(p => p.Credentials)
                .HasForeignKey(d => d.Employeeid)
                .HasConstraintName("Credential_Shift_FK");
        });
        ...
        modelBuilder.Entity<Shift>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Employeeld, e.StartDateTime }, "Shift_Employeeld_IDX");

            entity.Property(e => e.Id).HasColumnType("int(11)");
            entity.Property(e => e.Description).HasMaxLength(255);
            entity.Property(e => e.Employeeld).HasColumnType("int(11)");
